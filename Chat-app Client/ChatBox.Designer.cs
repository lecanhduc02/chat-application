namespace Chat_app_Client
{
	partial class ChatBox
	{
		...
		private void InitializeComponent()
		{
			...
			lblWelcome.Location = new Point(205, 12);
			lblWelcome.Name = "lblWelcome";
			lblWelcome.Size = new Size(125, 28);
			...
			txtReceiver.Location = new Point(376, 8);
			txtReceiver.Margin = new Padding(3, 4, 3, 4);
			txtReceiver.Name = "txtReceiver";
			txtReceiver.Size = new Size(183, 35);
			...
			// btnAddMember
			// 
			btnAddMember.BackColor = Color.MediumSlateBlue;
			...
			// btnDeleteGroup
			// 
			btnDeleteGroup.BackColor = Color.MediumSlateBlue;
			btnDeleteGroup.FlatStyle = FlatStyle.Flat;
			btnDeleteGroup.Font = new Font("Times New Roman", 12F, FontStyle.Bold, GraphicsUnit.Point);
			btnDeleteGroup.ForeColor = Color.Black;
			btnDeleteGroup.Location = new Point(12, 625);
			btnDeleteGroup.Margin = new Padding(3, 4, 3, 4);
			btnDeleteGroup.Name = "btnDeleteGroup";
			btnDeleteGroup.Size = new Size(174, 32);
			btnDeleteGroup.TabIndex = 32;
